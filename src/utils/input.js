                        ...
                        render={({ onChange, value }) => {
                            return (
                                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                    <KeyboardDatePicker disableToolbar format="yyyy-MM-dd" margin="normal" id={field.name} label={field.label} variant="outlined" onChange={onChange} value={value} KeyboardButtonProps={{'aria-label': 'change date'}} /> 
            ...
            return (
                <>
                    <Controller 
                        ...
                        defaultValue={field.default}
                        rules={{ required: field.mandatory }}
                        render={({ onChange, value }) => <TextareaAutosize id={field.name} label={field.label} variant="outlined" rowsMin={2} onChange={onChange} value={value} /> }
                    />
                    {errors[field.name] && <span className="text-danger">This field is required</span>}
                </>
            );
